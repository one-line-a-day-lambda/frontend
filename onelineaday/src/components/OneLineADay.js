...
export class OneLineADay extends React.Component {
    ...
    // Just get it rendering first.  Later spin this off into its own component
   ...
   componentDidMount(){ 
    ...
    render(){
        ...
        // Later, spin map off into its own component, use OneLineADay for rendering only
        return (
